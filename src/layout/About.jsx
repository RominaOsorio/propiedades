    ...
    <>
      <section id='about' className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'} w-full m-auto lg:px-40 px-10 py-20 grid lg:grid-cols-2 grid-cols-1 justify-center items-center gap-10`}>
        <div className='flex justify-center'>
          <img data-aos='zoom-in' src={aboutimg} alt='about image' className='rounded-2xl w-full max-w-[400px] md:max-w-[500px] md:h-[450px] lg:h-[600px] object-cover' />
        </div>

        <div className='flex flex-col justify-center items-start gap-8'>
          <h2 data-aos='zoom-in' className='text-red-500 dark:text-white uppercase font-semibold'>Quienes somos</h2>
          <h3 data-aos='zoom-in' data-aos-delay='200' className='text-black text-[28px] md:text-[32px] lg:text-[35px] font-semibold leading-10 dark:text-white'>
